...
title: Sample post with basic HTML elements
description: How tags like h1, h2, ul, table are rendered in Papicu
...
Footnotes are supported as part of [kramdown](https://kramdown.gettalong.org)'s &mdash; our Markdown parser &mdash; [extended syntax](https://kramdown.gettalong.org/syntax.html#footnotes). Here's one in action. Clicking this number[^fn-sample_footnote] will lead you to a footnote. 
...
### Subheader <span style="font-variant:normal;">`<h3>`</span>
