...
> As of April 2020, we are still using [Chart.js 2.9.4](https://www.chartjs.org/docs/2.9.4/). Some time in the future we might migrate to the new Chart.js 3+.
...
To create it, we used plain vanila CSS, but also made a few tricks[^2] with [kramdown](https://github.com/gettalong/kramdown/) (the Markdown parser we use). 
...
Now, onto a few more examples. The ones below are all closed by default. You will need to tap/click on them to expand (open).
...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Fortaleza_-_Cear%C3%A1_-_Brasil.jpg/640px-Fortaleza_-_Cear%C3%A1_-_Brasil.jpg" class="center-block responsive" />
